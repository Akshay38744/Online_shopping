                ...
                <table class="auto-style1">
                    <tr>
                        <td class="auto-style3">                       
                            <asp:ImageButton ID="imgbtn" runat="server" Height="100px" Width="100px" CssClass="border border-info" ImageUrl='<%# Eval("img")%>' CommandArgument='<%# Eval("Categoryname") %>' />
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Button ID="Button1" runat="server" CssClass="btn btn-primary" Text='<%# Eval("Categoryname") %>' CommandArgument='<%# Eval("Categoryname") %>' />
                        </td>
                    </tr>
                </table>
            ...
            <asp:DataList ID="DataList2" runat="server" BackColor="White" BorderColor="White" BorderStyle="None" BorderWidth="2px" CellPadding="3" RepeatDirection="Horizontal" CellSpacing="3" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" Height="211px" HorizontalAlign="Justify" RepeatColumns="5" style="text-align: center" TabIndex="3" OnItemCommand="DataList2_ItemCommand">
                ...
                <ItemStyle BackColor="#DEDFDE" ForeColor="Black" />
                    ...
                    <table class="auto-style7">
                        ...
                        <tr>
                            <td style="width: 228px">
                                <asp:Button ID="Button2" runat="server" Text="View Details"  CssClass="btn btn-outline-primary" CommandArgument='<%# Eval("pid")%>' CommandName="viewdetails" />
                                <asp:Button ID="Button3" runat="server" Text="Add to Cart"  CssClass="btn btn-outline-primary" CommandArgument='<%# Eval("pid")+","+ Eval("Price")%>' CommandName="addtocart" />
                            </td>
                        </tr>
                    </table>
                </ItemTemplate>
