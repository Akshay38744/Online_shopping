    ...
    <form id="form1" runat="server">
      <div class="auto-style8">
        ...
        <asp:Button ID="btnlogout" runat="server" CssClass="btn btn-warning" Text="Logout" style="z-index: 1; position: absolute; top: 9px; left: 1255px" OnClick="btnlogout_Click1" />      
         <div class="auto-style8">
        <div>
 <asp:GridView ID="grid"  runat="server" ShowFooter="true" AutoGenerateColumns="False" OnSelectedIndexChanged="grid_SelectedIndexChanged" CellPadding="3" ForeColor="#333333" GridLines="None" OnRowCommand="grid_RowCommand" DataKeyNames="Cid" OnRowEditing="grid_RowEditing" OnRowDeleting="grid_RowDeleting" OnRowCancelingEdit="grid_RowCancelingEdit" AllowSorting="True" OnRowUpdating="grid_RowUpdating" PageSize="2" AllowPaging="True" OnPageIndexChanging="grid_PageIndexChanging" CellSpacing="3">
        ...
        <asp:TemplateField ItemStyle-Width="100px">
            <HeaderTemplate>Category</HeaderTemplate>
                       <ItemTemplate>
                       <asp:Label ID="lblcname" Text='<%#Eval("Categoryname") %>' runat="server"></asp:Label>
                   </ItemTemplate>
                   <EditItemTemplate>
                       <asp:TextBox ID="txtCname" Text='<%#Eval("Categoryname") %>' runat="server"></asp:TextBox>
                   </EditItemTemplate>
                   <FooterTemplate>
...
<asp:Button ID="btnproduct" CssClass="btn" runat="server" Text="Add Product" OnClick="btnproduct_Click"/>
            ...
            <asp:Image ID="imgPhoto" Width="100px" Height="100px" runat="server" ImageUrl='<%#Bind("img") %>' />
                       ...
                       <asp:BoundColumn DataField="Cid" Visible="false"></asp:BoundColumn>
                       <asp:BoundColumn DataField="Pid" Visible="false"></asp:BoundColumn>
                      <asp:TemplateColumn Visible="false">
                          <ItemTemplate>
                              <asp:Label ID="labelc" runat="server" Text='<%#Eval("Categoryname") %>' Visible="false"></asp:Label>
                          </ItemTemplate>
                      </asp:TemplateColumn>
                     
                <asp:BoundColumn DataField="Categoryname" HeaderText="Category" Visible="true"></asp:BoundColumn>
                <asp:BoundColumn DataField="Productname" HeaderText="Product" Visible="true"></asp:BoundColumn>
                <asp:BoundColumn DataField="price" HeaderText="price" Visible="true"></asp:BoundColumn>
                <asp:BoundColumn DataField="Pdesc" HeaderText="Description" Visible="true"></asp:BoundColumn>
            ...
            <table class="auto-style1" style="table-layout: auto; border-style: double; height: 224px;">
                ...
                <tr>
                    <td class="auto-style2">
                        <asp:Label ID="lblpname" runat="server" Text="Productname"></asp:Label>
                    </td>
