...
public partial class Admin : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
       ...
       if (Session["uname"] != "Admin" && Session["uname"] == null)
        {
    ...
    protected void datagrid_ItemDataBound(object sender, DataGridItemEventArgs e)
    {
        ...
        {
            string Pname;
            if (Information.IsDBNull(DataBinder.Eval(e.Item.DataItem, "Productname")) == false)
            {
                Pname = (string)DataBinder.Eval(e.Item.DataItem, "Productname");
            }
            else
            {
                Pname = "";
    ...
    protected void btnadd_Click(object sender, EventArgs e)
    {
                ...
                else
                {
                    ...
                    if (validation() == true)
                    {
                        ...
                        cmd.Parameters.Add("@Subdate", DateTime.Now.ToString());
    ...
    protected void grid_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.Parameters.Add(new SqlParameter("@mode", SqlDbType.VarChar, 20));
        cmd.Parameters.Add("@cid", Convert.ToInt32(grid.DataKeys[e.RowIndex].Value.ToString()));
